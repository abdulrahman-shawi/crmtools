...
const defaultPages: PageRule[] = [
...

  {
    ...
    fields: [
      ...
      { id: "tsk_f_assignment_type", key: "assignmentType", label: "نوع الإسناد", type: "select", isRequired: true, isVisible: true },
      { id: "tsk_f_assignee", key: "assignee", label: "الموظف/الفريق", type: "select", isRequired: true, isVisible: true },
      { id: "tsk_f_task_type", key: "taskType", label: "نوع المهمة", type: "select", isRequired: true, isVisible: true },
      { id: "tsk_f_entity_type", key: "entityType", label: "المستهدف", type: "select", isRequired: true, isVisible: true },
      { id: "tsk_f_target", key: "targetCount", label: "العدد المطلوب", type: "number", isRequired: true, isVisible: true },
      { id: "tsk_f_completed", key: "completedCount", label: "المنجز", type: "number", isRequired: true, isVisible: true },
      ...
      { id: "tsk_f_notes", key: "notes", label: "ملاحظات", type: "textarea", isRequired: false, isVisible: true },
    ],
    tableColumns: [
      { id: "tsk_c_title", key: "title", label: "المهمة", isRequired: true, isVisible: true },
      { id: "tsk_c_assignment_type", key: "assignmentType", label: "نوع الإسناد", isRequired: true, isVisible: true },
      { id: "tsk_c_assignee", key: "assignee", label: "الموظف/الفريق", isRequired: true, isVisible: true },
      { id: "tsk_c_task_type", key: "taskType", label: "نوع المهمة", isRequired: true, isVisible: true },
      { id: "tsk_c_entity_type", key: "entityType", label: "المستهدف", isRequired: true, isVisible: true },
      { id: "tsk_c_target", key: "targetCount", label: "المطلوب", isRequired: true, isVisible: true },
      { id: "tsk_c_completed", key: "completedCount", label: "المنجز", isRequired: true, isVisible: true },
      { id: "tsk_c_progress", key: "progress", label: "التقدم", isRequired: false, isVisible: true },
